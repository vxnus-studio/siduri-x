...
export function runReleaseCheck(repoRoot: string = path.resolve(__dirname, '../..')): ReleaseCheckReport {
  ...
  const canonicalPackages = [
    { name: '@siduri-x/core', dir: 'packages/core', isOrgan: false, tarName: 'siduri-x-core-1.0.3.tgz' },
    ...
    { name: '@siduri-x/voice', dir: 'packages/organs/voice', isOrgan: true, tarName: 'siduri-x-voice-1.0.4.tgz' },
    { name: '@siduri-x/observation', dir: 'packages/organs/observation', isOrgan: true, tarName: 'siduri-x-observation-1.0.2.tgz' },
    { name: '@vxnus/siduri', dir: 'cli', isOrgan: false, tarName: 'vxnus-siduri-0.1.6.tgz' },
  ];
