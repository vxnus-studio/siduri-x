...
| --- | --- | --- |
| Blank-slate prompt rules | `siduri/tests/test_chat.py`, `siduri/packages/persona/prompt.py` | `@siduri-y/brain` prompt contract and regression tests |
| Chat routing and history bounds | `siduri/apps/chat/`, `siduri/apps/orchestrator/` | runtime channel/audience contract |
| Claim lifecycle | `siduri/docs/memory/TEACH_SIDURI.md`, `siduri/packages/memory/` | `@siduri-y/core` and memory organ |
