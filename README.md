...
| **`@siduri-x/core`** | `^2.0.11` | Runtime protocol, Truth Gate, response gating engine, capability tokens, and `SiduriDatabase` | **Implemented** |
...
| **`@siduri-x/knowledge`** | `^2.0.4` | Sovereign Life Database (Inventory, Finance, Schedule, Preferences) & optional E-Packs | **Implemented** |
...
| Package | Version | Description | Status |
| :--- | :---: | :--- | :--- |
| **`@siduri-x/brain`** | `^2.0.7` | Provider-neutral LLM reasoning, response planning, and proposal generation | **Implemented** |
