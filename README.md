...
| **`@siduri-x/core`** | `^2.0.12` | Runtime protocol, Truth Gate, response gating engine, capability tokens, and `SiduriDatabase` | **Implemented** |
...
| **`@siduri-x/knowledge`** | `^2.0.5` | Sovereign Life Database (Inventory, Finance, Schedule, Preferences) & optional E-Packs | **Implemented** |
...
| Package | Version | Description | Status |
| :--- | :---: | :--- | :--- |
| **`@siduri-x/brain`** | `^2.0.8` | Provider-neutral LLM reasoning, response planning, and proposal generation | **Implemented** |
